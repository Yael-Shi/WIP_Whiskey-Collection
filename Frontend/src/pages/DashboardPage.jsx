...
const StatCard = ({
  ...
  <div
    className={`p-5 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 dark:bg-gray-800 ${bgColorClass} text-white`}
  >
    <div className="flex items-center justify-between mb-3">
      <h3 className="text-lg font-semibold opacity-90">{title}</h3>
      <div
        className={`p-2 rounded-full ${iconColorClass} bg-black/10 dark:bg-white/10`}
      >
    ...
    {linkTo && (
      <Link
        to={linkTo}
        className="text-sm font-medium opacity-90 hover:opacity-100 transition-opacity flex items-center"
      >
...
const fetchDashboardStats = async (userId) =>
  new Promise((resolve) => {
    setTimeout(() => {
      resolve({
        totalWhiskeys: Math.floor(Math.random() * 50) + 5,
        totalTastings: Math.floor(Math.random() * 200) + 10,
        uniqueDistilleries: Math.floor(Math.random() * 20) + 3,
        ...
        [
          {
            ...
            image_url:
              'https://via.placeholder.com/150/F0E68C/000000?Text=Whiskey1',
          },
          {
            id: 'w2',
            ...
            image_url:
              'https://via.placeholder.com/150/FFD700/000000?Text=Whiskey2',
          },
          {
            id: 'w3',
            ...
            distillery: 'Ardbeg',
            image_url:
              'https://via.placeholder.com/150/D2B48C/000000?Text=Whiskey3',
          },
        ].slice(0, limit),
      );
    }, 700);
    ...
    setTimeout(() => {
      resolve(
        [
          {
            id: 't1',
            whiskeyName: 'Lagavulin 16 Year Old',
            rating: 4.5,
            date: '2024-07-15',
          },
          {
          ...
          {
            id: 't3',
            whiskeyName: 'Yamazaki 12 Year Old',
            rating: 4.8,
            date: '2024-06-28',
          },
        ].slice(0, limit),
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8">
        ...
        <section>
          <div className="flex justify-between items-center mb-4">
            ...
            <Link
              to="/collection"
              className="text-sm text-amber-600 hover:text-amber-700 dark:text-amber-400 dark:hover:text-amber-300 flex items-center"
            >
          ...
          {recentWhiskeys.length > 0 ? (
            <div className="space-y-3">
              {recentWhiskeys.map((whiskey) => (
                <div
                  key={whiskey.id}
                  className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow hover:shadow-md transition-shadow flex items-center space-x-4 rtl:space-x-reverse"
                >
                  <img
                    src={
                      whiskey.image_url ||
                      'https://via.placeholder.com/60/gray/white?text=W'
                    }
                    alt={whiskey.name}
                  ...
                  <div className="flex justify-between items-start">
                    <div>
                      ...
                      <p className="text-xs text-gray-500 dark:text-gray-400">
                        {new Date(tasting.date).toLocaleDateString('he-IL', {
                          year: 'numeric',
                          month: 'short',
                          day: 'numeric',
                        })}
