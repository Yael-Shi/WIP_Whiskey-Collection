...
const ProfilePage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const updatedUserFromApi = await updateUserProfileApi(
        user.id,
        profileDataToUpdate,
      );
      ...
      if (updateUserContext) {
        ...
        console.warn(
          'updateUserContext function is not available in AuthContext. User state might be stale.',
        );
      }
  ...
  if (formData.fullName) {
    userInitial = formData.fullName.charAt(0).toUpperCase();
  } else if (formData.email) {
    userInitial = formData.email.charAt(0).toUpperCase();
  } else {
    userInitial = 'U';
  }
    ...
    <div className="max-w-2xl mx-auto p-4 md:p-6 lg:p-8 space-y-8" dir="rtl">
      <header className="pb-6 border-b dark:border-gray-700">
        ...
        <p className="mt-1 text-gray-600 dark:text-gray-400">
          עדכן את פרטי החשבון והעדפות התצוגה שלך.
        </p>
      </header>
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-6 p-6 border-b dark:border-gray-700">
          ...
          {!isEditing && (
            <Button
              ...
              variant="outline"
              className="sm:ml-auto rtl:sm:mr-auto dark:border-gray-600 dark:text-gray-300 dark:hover:bg-gray-700"
            >
              ...
              <div className="flex flex-col sm:flex-row gap-3 pt-4 border-t dark:border-gray-700">
                ...
                >
                  {isSubmitting ? (
                    ...
                    <Save className="ml-2 rtl:mr-2 h-4 w-4" />
                  )}
                  שמור שינויים
                </Button>
                <Button
