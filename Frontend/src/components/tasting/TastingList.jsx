    ...
    return (
      ...
      >
        ...
        {addTastingUrl && (
          <Button
            asChild
            className="mt-6 bg-sky-600 hover:bg-sky-700 text-white dark:bg-sky-500 dark:hover:bg-sky-600"
          >
    ...
    >
      {tastings.map((tasting) => {
        if (!tasting || !tasting.id) {
          console.warn(
            'TastingList: Encountered a tasting item without an ID.',
            tasting,
          );
          return null;
        }
        ...
        return (
          <TastingCard
            ...
            onDelete={
              onDeleteTasting ? () => onDeleteTasting(tasting.id) : undefined
            }
          />
        );
      })}
