...
from app.services.user_service import authenticate_user, get_user_by_email, create_user as user_service_create_user
...
@router.post("/register", response_model=user_schema.User, status_code=status.HTTP_201_CREATED, tags=["Authentication"])
